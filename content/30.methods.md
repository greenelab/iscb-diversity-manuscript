...
For example, in the affiliation string
...
geotext detected 4 mentions of places in Germany: Saarland, Saarbrücken, Saarland, Germany.
In this case, we assign Germany to this affiliation.
...
For more details on this approach, please consult the accompanying [notebook](https://github.com/greenelab/iscb-diversity/blob/5213ba3451520af3967f74d8f58553dade0a826c/07.affiliations-to-countries.ipynb) and [label dataset](https://github.com/greenelab/iscb-diversity/blob/5213ba3451520af3967f74d8f58553dade0a826c/data/affiliations/geocode.jsonl).
...
For the above affiliation, the search order would be "Germany", "66123 Saarland", "Saarbrücken", "Max Planck Institute for Informatics", etc.
Since Nomatim would return a match for "Germany" (matched to Germany), the search would stop before getting to "66123 Saarland", and "Germany" would be assigned to this affiliation.
