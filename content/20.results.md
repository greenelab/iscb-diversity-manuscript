...
This was primarily driven by publications in Bioinformatics and BMC Bioinformatics (see [notebook](https://greenelab.github.io/iscb-diversity/15.analyze-affiliation.html)).
...
For each region, the geographical proportions of Pubmed articles affiliations are shown as teal LOESS curves, and the geographical proportions and 95% confidence interval of the ISCB affiliations are shown as dark circles and vertical lines (B).](https://raw.githubusercontent.com/greenelab/iscb-diversity/master/figs/region_breakdown.png){#fig:affiliation_breakdown}
