...
Full table with all countries can be browsed in the corresponding [analysis notebook](https://greenelab.github.io/iscb-diversity/15.analyze-affiliation.html#enrichment_tab).
{#tbl:enrichment_tab}
...
For each country, log odds ratio and its 95% confidence intervals are estimated from a Fisher’s exact test of authors and honorees whose affiliations are in that country compared to other countries (left). 
...
](https://raw.githubusercontent.com/greenelab/iscb-diversity/master/figs/enrichment-plot.png){#fig:enrichment_plot}
