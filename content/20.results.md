...
| ------ | ------ | -------------------- |
| European | 154,890 | Milano Koenders, Gerhard Eck, Eleonora Abbagnato, Alexei Yefimenko, Gérard Gili |
| CelticEnglish | 78,157 | Darren Wright, Anne Margaret McTaggart, Emma Victoria Jenkins, Joel Laslett Pott, John O'Conor |
| Hispanic | 66,931 | Susana Acosta, Cleiton Conceição, Gerardo Rodriguez Regordosa, Jorge Contreras, Mariangee Bogado |
| EastAsian | 54588 | Masahiko Nagasawa, Park Sae-young, Takuya Ide, Pham Doan Trang, Huang Qun |
| Muslim | 31,418 | Birkan Öksüz, Sania Saeed, Mohab El-Kordy, Navid Faridi, Masoud Soleimani Shojaei |
| Nordic | 28,978 | Ole Petter Pollen, Janni Spies, Juha-Pekka Haataja, Anne Molin Kongsgård, Hege Solbakken |
| SouthAsian | 20,025 | Swaraj Kaushal, Rohan Adnaik, Mariappan Periasamy, Bhim Bahadur Thapa, Uthpala Chakraborty |
| African | 17,826 | Chiguy Lucau, Cuthbert Nyasango, Nana Ampadu, Mary Essiful, Seraphin Mugabo |
| Jewish | 4,549 | Sheizaf Rafaeli, Miriam Zohar, Gidi Gov, Ness Nissim Zamir, Dalia Hertz |
| Greek | 4,138 | Nikolaos Anastasopoulos, Filippos Karampetsos, Maria Polyzou, Varvara Akritidou, Kora Karvouni |
