...
![Compared to the name collection of Pubmed authors, Group A honorees are overrepresented while Group C honorees are underrepresented. Category O represents all other groups. Estimated composition of name origin prediction over the years of
  ...
  was computed as the average of prediction probabilities of Pubmed articles or ISCB honorees each year.
  (B) For each region, we plotted the geographical proportions of article authors as teal LOESS curves and ISCB honorees as dark circles and vertical lines (error indicators show 95% confidence intervals).

](https://raw.githubusercontent.com/greenelab/iscb-diversity/master/figs/region_breakdown.png){#fig:region_breakdown}


### Assessing Affiliation Diversity of Authors and Honorees

We observed an increasing proportion of author affiliations in East Asia & the Pacific (Fig. {@fig:affiliation_breakdown}A, left).
This was primarily driven by publications in _Bioinformatics_ and _BMC Bioinformatics_ (see [notebook](https://greenelab.github.io/iscb-diversity/15.analyze-affiliation.html#sup_fig_s6)).
Among ISCB keynote speakers and fellows, we found that the majority of honorees were affiliated with institutions and companies from North America (Fig. {@fig:affiliation_breakdown}A, right).
We observed discrepancies between the affiliations of honorees and article authors.
Compared to authors, ISCB keynote speakers and fellows had a higher proportion of individuals affiliated with North American institutions and companies (Fig. {@fig:affiliation_breakdown}B) and lower proportion of individuals affiliated with institutions or companies from Europe & Central Asia and East Asia & the Pacific.

![Compared to authors, honorees affiliated with institutions from North America were overrepresented while those from Europe and Central Asia, East Asia & Pacific group were underrepresented.
We estimated the composition of affiliation locations each year for (A, left) computational biology and bioinformatics journal authors, and (A, right) all ISCB Fellows and keynote speakers.
For each region, the geographical proportions of Pubmed articles affiliations are shown as teal LOESS curves, and the geographical proportions and 95% confidence interval of the ISCB affiliations are shown as dark circles and vertical lines (B).
](https://raw.githubusercontent.com/greenelab/iscb-diversity/master/figs/geo_affiliation_breakdown.png){#fig:affiliation_breakdown}
