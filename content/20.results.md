...
](https://raw.githubusercontent.com/greenelab/iscb-diversity/534ac26f4419bd4a5bef6e521b40792f4f632b45/figs/gender_breakdown.png){#fig:gender_breakdown width="70%"}
...
A name coming from the group of honorees has significantly higher probability of being Celtic/English ($\beta$~Celtic/English~ = 0.10, _p_ = 7.2×10^-5^) and lower probability of being East Asian ($\beta$~East\ Asian~ = -0.12, _p_ = 3.9×10^-7^).
The two groups of scientists did not have a significant association with names predicted to be European and in Other categories (_p_ = 0.661 and _p_ = 0.663, respectively).
...
](https://raw.githubusercontent.com/greenelab/iscb-diversity/534ac26f4419bd4a5bef6e521b40792f4f632b45/figs/region_breakdown.png){#fig:region_breakdown}

When applying the Wiki2019-LSTM model to the name origins of only US-affiliated scientists, we found a similar but less severe underrepresentation of honorees with East Asian names ($\beta$~East\ Asian~ = -0.09, _p_ = 0.001).
We observed no statistically significant difference between the proportion of honorees and authors with Celtic/English names, European names, or names in Other categories (_p_ = 0.24, _p_ = 0.12, and _p_ = 0.88, respectively).
...
](https://raw.githubusercontent.com/greenelab/iscb-diversity/534ac26f4419bd4a5bef6e521b40792f4f632b45/figs/enrichment-plot.png){#fig:country-enrichment width="80%"}
...
](https://raw.githubusercontent.com/greenelab/iscb-diversity/534ac26f4419bd4a5bef6e521b40792f4f632b45/figs/us_racial_makeup.png){#fig:us_racial_makeup}
