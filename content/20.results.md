...
### Improvments to Honoree Diversity Subsequent to Our Primary Analysis

While our study was primarily designed to assess the diversity of honorees, the findings raise important questions about what can be done to address the situation.
The widespread adoption of preprints in biology and medicine enables us to begin to address these questions by examining any changes subsequent to our initial report.
...
These new results suggest two things: 1) honorees with appropriate levels of accomplishment who were members of under-recognized groups existed but were not being recognized; and 2) that in certain situations simply examining honoree distribution's alignment with the field can begin to address issues of unequal representation.
