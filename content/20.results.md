...
In a [previous version](https://greenelab.github.io/iscb-diversity-manuscript/v/711edb01f5335a4c1bb8e1e0575618586a7abf9b/) of this work, instead of last authors, we examined corresponding authors of articles in three well-recognized computational biology journals, and the results were consistent with our findings here.
...
We sought to examine whether there is a difference in the probability of a name being female between the two groups of scientists. 
A multiple linear regression of this probability on the groups and year did not reveal a significant difference (_p_ = 0.558).
