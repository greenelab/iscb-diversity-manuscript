...
Further, taking all the years together, a Welch two-sample t-test did not reveal any statistically significant difference in the mean probability of ISCB speakers predicted to be female compared to that of authors (t~418~ = 0.753, p = 0.226).
...
](https://raw.githubusercontent.com/greenelab/iscb-diversity/master/figs/enrichment-plot.png){#fig:enrichment_plot width="80%"}
