...
We observed an increasing proportion of author affiliation located in East Asia & Pacific (Fig. {@fig:affiliation_breakdown}A, left).
...
Noting the small sample size, we found discrepancies between the group of honoree composition versus PubMed. 
Compared to Pubmed authors, ISCB keynote speakers and fellows have a higher proportion of individuals affiliated with North American institutions and companies (Fig. {@fig:affiliation_breakdown}B) and lower proportion of individuals affiliated with institutions or companies from Europe & Central Asia and East Asia & Pacific. 

![Compared to Pubmed authors, honorees affiliated with institutions from North America are overrepresented while those from Europe and Central Asia, East Asia & Pacific group are underrepresented.
Estimated composition of affiliation locations over the years of (A, left) all Pubmed computational biology and bioinformatics journal authors, and (A, right) all ISCB Fellows and keynote speakers was computed as the geographical proportions of Pubmed articles or ISCB honorees affiliations each year.
