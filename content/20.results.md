...
We also elected to use authorships instead of authors because name disambiguation can be error prone, and because the overall design of the work was to examine distributions the precise linking of researchers was not necessary to address the research question.
...
We performed the analysis across different combinations of the above choices and results were consistent with respect to the broad conclusions, though the numerical results differed (see Methods and supplementary figure S3).
