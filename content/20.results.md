...
![The Wiki2019-LSTM model shows strong ability to predict all of the categories all the test data sets (all values for area under the ROC curve is above 94%).
