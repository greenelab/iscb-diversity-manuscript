...
Of 34,005 corresponding authors, 45 have empty fore name field (i.e., missing metadata), 1,466 have fore name that is None once simplified (i.e., initials), and 1,578 have fore name for which genderize did not provide predictions.
