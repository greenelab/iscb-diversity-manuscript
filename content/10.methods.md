...
Of 34,005 corresponding authors, 45 have empty fore name field (i.e., missing metadata), 1,466 have fore name that is None once simplified (i.e., initials), and 1,578 have fore name for which genderize.io did not provide predictions.
...
Of 34,050 corresponding authors, 40 have empty last name field (i.e., missing metadata), and 8,770 have fore name for which `wru` did not provide predictions.
