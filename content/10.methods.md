...
Therefore, we designed a method for extracting countries from affiliations that accommodated multiple countries.
...
When a match was found, we used extracted the country containing the location.
